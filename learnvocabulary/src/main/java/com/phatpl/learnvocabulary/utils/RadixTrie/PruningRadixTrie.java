...
public class PruningRadixTrie {
    ...
    public static long termCount = 0;
    public static long termCountLoaded = 0;

    //The trie
    public static Node trie = new Node(0);
    ...
    public static void addTerm(String term, long termFrequencyCount) {
        List<Node> nodeList = new ArrayList<>();
        addTerm(trie, term, termFrequencyCount, 0, nodeList);
    }

    public static void updateMaxCounts(List<Node> nodeList, long termFrequencyCount) {
    ...
    public static void addTerm(Node curr, String term, long termFrequencyCount, int level, List<Node> nodeList) {
        try {
            nodeList.add(curr);
                ...
                for (int j = 0; j < currChildren.size(); j++) {
                    ...
                    if (common > 0) {
                        ...
                        //new:      test
                            ...
                            addTerm(node, term.substring(common), termFrequencyCount, level + 1, nodeList);
                        }
    ...
    public static void findAllChildTerms(String prefix, int topK, String prefixString, List<TermAndFrequency> results, Boolean pruning) // Removed 3rd parameter: ref long termFrequencyCountPrefix
    {
        findAllChildTerms(prefix, trie, topK, prefixString, results, null, pruning);
    }

    public static void findAllChildTerms(String prefix, Node curr, int topK, String prefixString, List<TermAndFrequency> results, BufferedWriter file, Boolean pruning) // Removed 4th parameter: ref long termfrequencyCountPrefix
    {
        try {
    ...
    public static List<TermAndFrequency> getTopkTermsForPrefix(String prefix, int topK) {
        return getTopkTermsForPrefix(prefix, topK, true);
    }

    public static List<TermAndFrequency> getTopkTermsForPrefix(String prefix, int topK, Boolean pruning) { // Removed parameter 'out long termFrequencyCountPrefix' as returning it in Java would mean changing the return type of the method.
    ...
    public static void writeTermsToFile(String path) {
    ...
    public static Boolean readTermsFromFile(String path, String delimiter) { // Introduced parameter fieldDelimiter, the string on each line that separates the word from the frequency. Eg use value "\t" for tab delimited dictionary files.
    ...
    public static void addTopKSuggestion(String term, long termFrequencyCount, int topK, List<TermAndFrequency> results) {
